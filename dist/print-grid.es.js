...
const useMq = (queries, values, defaultValue) => {
...
const isNil = (input) => input !== void 0;
const PrintGrid = (props) => {
  const {
    as,
    className,
    portrait,
  ...
  return /* @__PURE__ */ jsx(Tag, {
    ...
    style: __spreadValues({}, gridStyles),
    children: gridItems
  });
};
export { PrintGrid as default };
